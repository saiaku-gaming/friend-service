...
public class FriendServiceClient extends AbstractServiceClient {
    ...
    public RestResponse<String> cancelCharacterInvite(String username, String characterName) throws IOException {
        return restCaller.postCall(serviceServerUrl + "/v1/friend/cancel-character-invite",
                new CancelCharacterInviteParameter(username, characterName), String.class);
    }
